...
> Archivo maestro de integración. Puede usarse como punto de partida para copiar a Word, LaTeX o el documento principal.

<!-- INCLUDE: sections/01_resultados_optimizacion_triobjetivo_v1.md -->
