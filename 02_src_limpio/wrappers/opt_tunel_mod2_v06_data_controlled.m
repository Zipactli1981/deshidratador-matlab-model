function [Q_aux_tot, dry_time, M_prod_fin, MR_fin, Irradiacion] = opt_tunel_mod2_v06_data_controlled(m_max,T_min,r_div2,t_rec_ini, W0, m_i, Mi, mwi, md, m_f, Mf, mwf, M_des)
