% v18 endpoint-TMAX-corrected clone generated by implement_tmax_endpoint_correction_clone_v95j on 2026-06-27 11:23:01
% Correction: TMAX endpoint uses current state M_prod(i) and recalculated MR.
function [Q_aux_tot, dry_time, M_prod_fin, MR_fin, Irradiacion, irr_diag] = opt_tunel_mod2_v18_endpoint_TMAX_corrected(m_max,T_min,r_div2,t_rec_ini, W0, m_i, Mi, mwi, md, m_f, Mf, mwf, M_des, mode_operation)
