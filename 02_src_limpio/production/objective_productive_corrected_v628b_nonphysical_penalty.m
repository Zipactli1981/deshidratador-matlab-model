function [f, detail] = objective_productive_corrected_v628b_nonphysical_penalty(x, mode_operation)
...
%   in the current controlled branch.
    ...
    detail.created_by_function = 'objective_productive_corrected_v628b_nonphysical_penalty';
