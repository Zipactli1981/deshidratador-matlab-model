...
% RUN_GUARDED_TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE
...
%   - Marca CO2 con factores provisionales.
    ...
    formalDir = fullfile(formalBaseDir,['TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE_' timestamp]);
...
rngStateAfterSeed_v96z = rng;
    ...
    outPreflightCsv = fullfile(tablesDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE_preflight.csv');
    ...
    outSourceCsv = fullfile(tablesDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE_source_scan.csv');
    ...
    outRawMat = fullfile(matDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE_raw.mat');
    ...
    outSolutionsCsv = fullfile(tablesDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE_solutions.csv');
    ...
    outReferenceCsv = fullfile(tablesDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE_gasLP_reference.csv');
    ...
    outRunCsv = fullfile(tablesDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE_run_summary.csv');
    ...
    outChecksCsv = fullfile(tablesDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE_checks.csv');
    ...
    % Salidas MAT
    % ---------------------------------------------------------------------
    outMd = fullfile(logsDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE.md');
    outTxt = fullfile(logsDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE.txt');
    outMat = fullfile(matDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE.mat');
    ...
    fprintf(fid,'# TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE\n\n');
    fprintf(fid,'## Estado\n\n');
    ...
    fprintf(fid,'status: TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE_COMPLETED\n');
    ...
    % ---------------------------------------------------------------------
    formal = struct();
    formal.status = 'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE_COMPLETED';
...
formal.rngStateAfterSeed_v96z = rngStateAfterSeed_v96z;
    ...
    disp('=== TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_SMOKE ===')
    disp(formal.status)
    disp('=== DIAGNOSIS ===')
