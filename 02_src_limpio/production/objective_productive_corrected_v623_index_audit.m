function [f, detail] = objective_productive_corrected_v623_index_audit(x, mode_operation)
...
%     opt_tunel_mod2_v12_index_audit.m
...
%   in the current controlled branch.
    ...
    detail.created_by_function = 'objective_productive_corrected_v623_index_audit';
