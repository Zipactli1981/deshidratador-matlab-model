...
%   smoke = run_seedaware_smoke_seed_difference_v96z_rngfix(true);   % ejecutar smoke
    ...
    smokeCloneName = 'run_guarded_triobjective_formal_ga_v96m_seedaware_v96z_rngfix_SMOKE';
    ...
    src = replace(src, ...
        ...
        "function formal = run_guarded_triobjective_formal_ga_v96m_seedaware_v96z_rngfix_SMOKE(confirm_execute, rngSeed)");
    ...
    if confirm_execute
        for i = 1:2
            ...
            try
                tRep = tic;
                formal = run_guarded_triobjective_formal_ga_v96m_seedaware_v96z_rngfix_SMOKE(true, seed);
                elapsed = toc(tRep);
