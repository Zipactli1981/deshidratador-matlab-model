%% patch_master_mathematical_model_draft_v96z.m
% 9.6z-draft-d
...
Tchecks = addCheck(Tchecks, 'MMD-PRE-09', 'Required model anchors exist before drafting', ...
...
Tchecks = addCheck(Tchecks, 'MMD-DRAFT-04', 'Draft contains Q_aux and LPG interpretation', ...
    contains(string(modelBlock), 'Q_aux') && contains(string(modelBlock), 'LPG'), ...
    sprintf('Qaux=%d LPG=%d', contains(string(modelBlock), 'Q_aux'), contains(string(modelBlock), 'LPG')));
...
Tchecks = addCheck(Tchecks, 'MMD-DRAFT-06', 'Draft contains 2-SAH sensitivity statement', ...
    contains(string(modelBlock), '2-SAH') && contains(lower(string(modelBlock)), 'sensitivity'), ...
    sprintf('2SAH=%d sensitivity=%d', contains(string(modelBlock), '2-SAH'), contains(lower(string(modelBlock)), 'sensitivity')));

Tchecks = addCheck(Tchecks, 'MMD-DRAFT-07', 'Draft keeps cost and CO2 conditional', ...
    contains(string(modelBlock), 'source-locked assumptions') && contains(string(modelBlock), 'CO2'), ...
    sprintf('sourceLocked=%d CO2=%d', contains(string(modelBlock), 'source-locked assumptions'), contains(string(modelBlock), 'CO2')));
...
Tchecks = addCheck(Tchecks, 'MMD-POST-06', 'Mathematical model contains Q_aux and MR criterion', ...
    contains(string(modelAfter), 'Q_aux') && contains(string(modelAfter), 'MR <= 0.1'), ...
    sprintf('Qaux=%d MR=%d', contains(string(modelAfter), 'Q_aux'), contains(string(modelAfter), 'MR <= 0.1')));
