%% patch_master_optimization_methodology_completion_v96z_v2.m
% 9.6z-draft-e
...
Tchecks = addCheck(Tchecks, 'MOMC-PRE-10', 'Required pre-existing methodology anchors acceptable before completion', ...
...
Tchecks = addCheck(Tchecks, 'MOMC-PRE-11', 'Results section captured for no-change protection before completion', ...
    strlength(string(resultsSegBefore)) > 1000, ...
