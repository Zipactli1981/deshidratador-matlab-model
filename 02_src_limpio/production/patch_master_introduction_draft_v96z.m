%% patch_master_introduction_draft_v96z.m
% 9.6z-draft-b
...
Tchecks = addCheck(Tchecks, 'MID-PRE-08', 'Introduction scaffold subheadings present once', ...
    subheadsOK, join(subheadEvidence, ' | '));
