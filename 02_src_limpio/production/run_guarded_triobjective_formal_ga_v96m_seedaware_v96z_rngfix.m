...
%   - Marca CO2 con factores provisionales.
    ...
    formalDir = fullfile(formalBaseDir,['TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_' timestamp]);
...
rngStateAfterSeed_v96z = rng;
    ...
    outPreflightCsv = fullfile(tablesDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_preflight.csv');
    ...
    outSourceCsv = fullfile(tablesDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_source_scan.csv');
    ...
    outRawMat = fullfile(matDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_raw.mat');
    ...
    outSolutionsCsv = fullfile(tablesDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_solutions.csv');
    ...
    outReferenceCsv = fullfile(tablesDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_gasLP_reference.csv');
    ...
    outRunCsv = fullfile(tablesDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_run_summary.csv');
    ...
    outChecksCsv = fullfile(tablesDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_checks.csv');
    ...
    % Salidas MAT
    % ---------------------------------------------------------------------
    outMd = fullfile(logsDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix.md');
    outTxt = fullfile(logsDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix.txt');
    outMat = fullfile(matDir,'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix.mat');
    ...
    fprintf(fid,'# TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix\n\n');
    fprintf(fid,'## Estado\n\n');
    ...
    fprintf(fid,'status: TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_COMPLETED\n');
    ...
    % ---------------------------------------------------------------------
    formal = struct();
    formal.status = 'TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix_COMPLETED';
...
formal.rngStateAfterSeed_v96z = rngStateAfterSeed_v96z;
    ...
    disp('=== TRIOBJECTIVE_FORMAL_GA_v96m_seedaware_v96z_rngfix ===')
    disp(formal.status)
    disp('=== DIAGNOSIS ===')
