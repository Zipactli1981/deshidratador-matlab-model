...
## Diagnóstico secundario de presupuesto extendido 61001×400 — cerrado con postrun

Campaña `ROR_BUDGET_DIAGNOSTIC_61001_G400_V01`; rol `SECONDARY_EXTENDED_BUDGET_DIAGNOSTIC`; estado `COMPLETED_POSTRUN`. La ejecución alcanzó 400 generaciones/9600 evaluaciones con integridad 21/21 y snapshots 8/8. El manifest conserva su estado histórico previo al postrun `COMPLETED_PENDING_POSTRUN`; no existe un manifest postrun separado. La campaña primaria 5×200, su FAIL de suficiencia y su N_POOL permanecen inalterados.
...
| `02_src_limpio/audit/robust_operating_region_v01/extended_diagnostic_source_lock.json` | `EXTENDED_BUDGET_SOURCE_LOCK` | `358DDE5EE0077B4D0DDA618E2787C8213442681A41090F056F2603C4950482FB` | Protocolo, infraestructura, dependencias productivas y referencia primaria 61001 | 16/16 hashes PASS tras root-reservation fix |
| `02_src_limpio/audit/robust_operating_region_v01/run_ror_extended_budget_diagnostic.m` | `EXTENDED_BUDGET_DIAGNOSTIC_RUNNER` | `D5CF3906B5F856791625F0556DC9BAA1096CB7509446951D0386B914C0A01DB9` | Config y source lock diagnósticos; objective productivo | Ejecución única efectiva sobre HEAD `4e2ad869...`; manifest/provenance/hash inventory PASS |
...
| `02_src_limpio/audit/robust_operating_region_v01/ror_extended_root_guard.m` | `EXTENDED_BUDGET_OUTPUT_ROOT_GUARD` | `43CBB1A0BBCC052305835DBB10E7756B9E75D4715892CAA14DC7D0C2BA4634C0` | Política de root diagnóstica separada y no-overwrite | Parent idempotente + reserva exclusiva; colisión fail-closed; 6/6 casos PASS |
| `02_src_limpio/audit/robust_operating_region_v01/ror_extended_diagnostic_postrun.py` | `EXTENDED_BUDGET_DIAGNOSTIC_POSTRUN` | `F7A32DE362710CB1978A7E08E437739A7B39847A2026834DB5612242D5196261` | Snapshots G200/FINAL_G400 y referencia primaria 61001 congelada | Fixtures A/B/C/D PASS y postrun real cerrado categoría D; reporte hash-valid |
| `02_src_limpio/audit/robust_operating_region_v01/test_ror_extended_diagnostic_dry.m` | `EXTENDED_BUDGET_MATLAB_DRY_TEST` | `DD35A8AE7FCFBE5EEC577DA71E2F06331E7C6C279DBD3866423F326F219812D0` | Callback, guards, configuración, opciones y filesystem temporal | ROOT_RESERVATION_FIX_VALIDATION = 6/6 synthetic root cases PASS + MATLAB dry PASS; 0 gamultiobj/model/objective |
...
### Raíz y artefactos de ejecución/postrun

Raíz física: `05_runs/robust_operating_region_v01/extended_budget_diagnostic/ROR_BUDGET_DIAGNOSTIC_61001_G400_V01/`.

| Path | Role | SHA-256 | Upstream | Validation basis |
|---|---|---|---|---|
| `05_runs/robust_operating_region_v01/extended_budget_diagnostic/ROR_BUDGET_DIAGNOSTIC_61001_G400_V01/` | `EXTENDED_BUDGET_EXECUTION_ROOT` | `N/A — DIRECTORY` | Runner, protocolo, config y source lock extendidos | Reserva exclusiva; campaña/seed/HEAD exactos; contenido auditado por manifest e inventario 21/21 |
| `05_runs/robust_operating_region_v01/extended_budget_diagnostic/ROR_BUDGET_DIAGNOSTIC_61001_G400_V01/EXECUTION_MANIFEST.json` | `EXTENDED_BUDGET_EXECUTION_MANIFEST` | `437976921344898BCC7124B814013EBED66F5C0CD6D0A1CFD3302DC31CA6B553` | Ejecución 61001×400 sobre HEAD `4e2ad869...` | `COMPLETED_PENDING_POSTRUN`; exitflag 0; generación 400; source lock embebido 16/16 |
| `05_runs/robust_operating_region_v01/extended_budget_diagnostic/ROR_BUDGET_DIAGNOSTIC_61001_G400_V01/PROVENANCE.json` | `EXTENDED_BUDGET_EXECUTION_PROVENANCE` | `926AF2BB1E753D1B7B547303F870D8F9877B0795B867017142FF70E86D985FFC` | Config, source lock, solver y referencia primaria 61001 | Coincide con inventario; MATLAB `26.1.0.3312084 (R2026a) Update 4`; PCWIN64 |
| `05_runs/robust_operating_region_v01/extended_budget_diagnostic/ROR_BUDGET_DIAGNOSTIC_61001_G400_V01/SHA256_INVENTORY.json` | `EXTENDED_BUDGET_EXECUTION_HASH_INVENTORY` | `6C4E43B4DDB9E8C190593819040CF2DF853372349BDFCE24CA21900CF17A517C` | 21 artefactos de ejecución y snapshots | Verificación física read-only 21/21 PASS; sidecars 8/8 PASS |
| `05_runs/robust_operating_region_v01/extended_budget_diagnostic/ROR_BUDGET_DIAGNOSTIC_61001_G400_V01/snapshots/G200.mat` | `EXTENDED_BUDGET_G200_SNAPSHOT` | `E7F896BE9BE4BFE2689704921E2D44936E0A77F802533615968F7E62DF7653AD` | Trayectoria extendida 61001×400, generación 200 | Inventario y sidecar PASS; `ALTERNATIVE_400GEN_BUDGET_TRAJECTORY`, no sustituto de PRIMARY 61001×200 |
| `05_runs/robust_operating_region_v01/extended_budget_diagnostic/ROR_BUDGET_DIAGNOSTIC_61001_G400_V01/snapshots/FINAL_G400.mat` | `EXTENDED_BUDGET_FINAL_G400_SNAPSHOT` | `A39410582BF54AFD5CD56DF8E853866B450055C40E8DC1B2CD074E9EEF18FF44` | Trayectoria extendida 61001×400, generación final | Inventario y sidecar PASS; input numérico del postrun dentro de la misma trayectoria |
| `05_runs/robust_operating_region_v01/extended_budget_diagnostic/ROR_BUDGET_DIAGNOSTIC_61001_G400_V01/EXTENDED_FINAL.mat` | `EXTENDED_BUDGET_PRIMARY_NUMERIC_OUTPUT` | `575B43010A78591CE318E5DF526696DCBEDBF3C811BA8AF951D5A80A9463200B` | Salida solver 61001×400 | Inventario PASS; exitflag 0, generación 400, funccount 9600 |
